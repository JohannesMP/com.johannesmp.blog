...
While there several guides for installing jekyll for Windows ([official github pages](https://help.github.com/articles/setting-up-your-github-pages-site-locally-with-jekyll/), [just jekyll](http://jekyll-windows.juthilo.com)) They seem to skip several key points that have given me trouble with the latest version of ruby (2.3.3 as of this writing) on Windows 10.
